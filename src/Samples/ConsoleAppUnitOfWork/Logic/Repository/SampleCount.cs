...
public class SampleCount
{
    ...
    public static void Executar()
    {
        try
        {
            ...
            var contador = _unitOfWork.GetRepository<Employees>().Count();
        ...
        {
            Console.WriteLine($"Count encerrado inesperadamente Exceção: {ex.GetType().FullName} | " + $"Mensagem: {ex.Message}");
            throw;
        }
    }
