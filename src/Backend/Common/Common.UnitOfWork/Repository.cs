...
namespace Common.UnitOfWork
{
    ...
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        /// Gets all entities. 
        /// </summary>
        /// <param name="filter.Predicate">A function to test each element for a condition.</param>
        /// <param name="filter.OrderBy">A function to order elements.</param>
        /// <param name="filter.Include">A function to include navigation properties</param>
        /// <param name="filter.DisableTracking"><c>true</c> to disable changing tracking; otherwise, <c>false</c>. Default to <c>true</c>.</param>
        /// <param name="filter.IgnoreQueryFilters">Ignore query filters</param>
        /// <returns>An <see cref="IQueryable{TEntity}"/> that contains elements that satisfy the condition specified by <paramref name="predicate"/>.</returns>
        /// <remarks>Ex: This method defaults to a read-only, no-tracking query.</remarks>
        public IQueryable<TEntity> GetAll(Filter<TEntity> filter)
        {
            return GetAll(filter.Predicate, filter.OrderBy, filter.Include, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
        ...
        /// <returns>An <see cref="IQueryable{TEntity}"/> that contains elements that satisfy the condition specified by <paramref name="predicate"/>.</returns>
        /// <remarks>Ex: This method defaults to a read-only, no-tracking query.</remarks>
        public IQueryable<TResult> GetAll<TResult>(Expression<Func<TEntity, TResult>> selector, Filter<TEntity> filter)
        {
            return GetAll(selector, filter.Predicate, filter.OrderBy, filter.Include, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
        ...
        /// <param name="filter.DisableTracking"><c>true</c> to disable changing tracking; otherwise, <c>false</c>. Default to <c>true</c>.</param>
        /// <param name="filter.IgnoreQueryFilters">Ignore query filters</param>
        /// <returns>An <see cref="IList{TEntity}"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>Ex: This method defaults to a read-only, no-tracking query.</remarks>
        public async Task<IList<TEntity>> GetAllAsync(Filter<TEntity> filter)
        {
            return await GetAllAsync(filter.Predicate, filter.OrderBy, filter.Include, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
        ...
        /// <returns>An <see cref="IList{TEntity}"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>Ex: This method defaults to a read-only, no-tracking query.</remarks>
        public async Task<IList<TResult>> GetAllAsync<TResult>(Expression<Func<TEntity, TResult>> selector, Filter<TEntity> filter)
        {
            return await GetAllAsync(selector, filter.Predicate, filter.OrderBy, filter.Include, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
        ...
        /// <param name="filter.OrderBy">A function to order elements.</param>
        /// <param name="filter.Include">A function to include navigation properties</param>
        /// <param name="filter.PageIndex">The index of page.</param>
        /// <param name="filter.PageSize">The size of the page.</param>
        /// <param name="filter.DisableTracking"><c>True</c> to disable changing tracking; otherwise, <c>false</c>. Default to <c>true</c>.</param>
        /// <param name="filter.CancellationToken">
        ///     A <see cref="CancellationToken" /> to observe while waiting for the task to complete.
        /// </param>
        /// <param name="filter.IgnoreQueryFilters">Ignore query filters</param>
        /// <returns>An <see cref="IPagedList{TEntity}"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method default no-tracking query.</remarks>
        public virtual IPagedList<TEntity> GetPagedList(PagedFilter<TEntity> filter)
        {
            return GetPagedList(filter.Predicate, filter.OrderBy, filter.Include, filter.PageIndex, filter.PageSize, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
        ...
        /// <returns>An <see cref="IPagedList{TEntity}"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method default no-tracking query.</remarks>
        public virtual Task<IPagedList<TEntity>> GetPagedListAsync(PagedFilter<TEntity> filter)
        {
            return GetPagedListAsync(filter.Predicate, filter.OrderBy, filter.Include, filter.PageIndex, filter.PageSize, filter.DisableTracking, filter.CancellationToken, filter.IgnoreQueryFilters, filter.SplitQuery);
        }
        ...
        /// <param name="filter.DisableTracking"><c>True</c> to disable changing tracking; otherwise, <c>false</c>. Default to <c>true</c>.</param>
        /// <param name="filter.IgnoreQueryFilters">Ignore query filters</param>
        /// <returns>An <see cref="IPagedList{TResult}"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method default no-tracking query.</remarks>
        public virtual IPagedList<TResult> GetPagedList<TResult>(Expression<Func<TEntity, TResult>> selector, PagedFilter<TEntity> filter) where TResult : class
        {
            return GetPagedList(selector, filter.Predicate, filter.OrderBy, filter.Include, filter.PageIndex, filter.PageSize, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
        ...
        /// <returns>An <see cref="IPagedList{TEntity}"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method default no-tracking query.</remarks>
        public virtual Task<IPagedList<TResult>> GetPagedListAsync<TResult>(Expression<Func<TEntity, TResult>> selector, PagedFilter<TEntity> filter) where TResult : class
        {
            return GetPagedListAsync(selector, filter.Predicate, filter.OrderBy, filter.Include, filter.PageIndex, filter.PageSize, filter.DisableTracking, filter.CancellationToken, filter.IgnoreQueryFilters);
        }
        ...
        /// <param name="filter.DisableTracking"><c>True</c> to disable changing tracking; otherwise, <c>false</c>. Default to <c>true</c>.</param>
        /// <param name="filter.IgnoreQueryFilters">Ignore query filters</param>
        /// <returns>An <see cref="TEntity"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method default no-tracking query.</remarks>
        public virtual TEntity GetFirstOrDefault(Filter<TEntity> filter)
        {
            return GetFirstOrDefault(filter.Predicate, filter.OrderBy, filter.Include, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
        ...
        /// <returns>An <see cref="TEntity"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method default no-tracking query.</remarks>
        public virtual async Task<TEntity> GetFirstOrDefaultAsync(Filter<TEntity> filter)
        {
            return await GetFirstOrDefaultAsync(filter.Predicate, filter.OrderBy, filter.Include, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
        ...
        /// <returns>An <see cref="TEntity"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method default no-tracking query.</remarks>
        public virtual TResult GetFirstOrDefault<TResult>(Expression<Func<TEntity, TResult>> selector, Filter<TEntity> filter)
        {
            return GetFirstOrDefault(selector, filter.Predicate, filter.OrderBy, filter.Include, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
        ...
        /// <returns>An <see cref="TEntity"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method default no-tracking query.</remarks>
        public virtual async Task<TResult> GetFirstOrDefaultAsync<TResult>(Expression<Func<TEntity, TResult>> selector, Filter<TEntity> filter)
        {
            return await GetFirstOrDefaultAsync(selector, filter.Predicate, filter.OrderBy, filter.Include, filter.DisableTracking, filter.IgnoreQueryFilters);
        }
