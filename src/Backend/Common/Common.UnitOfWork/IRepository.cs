...
namespace Common.UnitOfWork
{
    ...
    public interface IRepository<TEntity> where TEntity : class
    {
        ...
        /// <remarks>This method default no-tracking query.</remarks>
        IPagedList<TEntity> GetPagedList(PagedFilter<TEntity> filter);
        ...
        /// <returns>An <see cref="IPagedList{TEntity}"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method default no-tracking query.</remarks>
        Task<IPagedList<TEntity>> GetPagedListAsync(PagedFilter<TEntity> filter);
        ...
        /// <remarks>This method default no-tracking query.</remarks>
        IPagedList<TResult> GetPagedList<TResult>(Expression<Func<TEntity, TResult>> selector,
                                                  PagedFilter<TEntity> filter) where TResult : class;
        ...
        /// <remarks>This method defaults to a read-only, no-tracking query.</remarks>
        TEntity GetFirstOrDefault(Filter<TEntity> filter);
        ...
        /// <returns>An <see cref="TEntity"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>This method defaults to a read-only, no-tracking query.</remarks>
        TResult GetFirstOrDefault<TResult>(Expression<Func<TEntity, TResult>> selector, Filter<TEntity> filter);
        ...
        /// <returns>An <see cref="TEntity"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>Ex: This method defaults to a read-only, no-tracking query. </remarks>
        Task<TEntity> GetFirstOrDefaultAsync(Filter<TEntity> filter);
        ...
        /// <param name="filter.DisableTracking"><c>true</c> to disable changing tracking; otherwise, <c>false</c>. Default to <c>true</c>.</param>
        /// <param name="filter.IgnoreQueryFilters">Ignore query filters</param>
        /// <returns>An <see cref="IQueryable{TEntity}"/> that contains elements that satisfy the condition specified by <paramref name="filter.Predicate"/>.</returns>
        /// <remarks>Ex: This method defaults to a read-only, no-tracking query.</remarks>
        IQueryable<TEntity> GetAll(Filter<TEntity> filter);
        ...
        /// <remarks>Ex: This method defaults to a read-only, no-tracking query.</remarks>
        Task<IList<TEntity>> GetAllAsync(Filter<TEntity> filter);
